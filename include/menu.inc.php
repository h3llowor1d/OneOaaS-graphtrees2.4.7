...
$ZBX_MENU = array(
	'view' => array(
		...
		'pages' => array(
			...
			array(
				'url' => 'charts_netflow.php',
				'label' => _('Network'),
				'sub_pages' => array('chart2_netflow.php')
			),
            array(
                'url' => 'graphtrees.php',
                'label' => _('Graphtrees'),
                'sub_pages' => array('graphtree.left.php', 'graphtree.right.php',"biggraph.php")
            ),
			array(
				'url' => 'screens.php',
				'label' => _('Screens'),
	...
	'reports' => array(
		...
		'pages' => array(
			...
			array(
				'url' => 'report.dataview.php',
				'label' => _('Data view'),
				'sub_pages' => array('popup_period.php', 'popup_bitem.php', 'chart_bar.php')
			),
			array(
				'url' => 'report.datagraph.php',
				'label' => _('Data graph'),
				'sub_pages' => array('popup_period.php', 'popup_bitem.php', 'chart_bar.php')
			),
			array(
				'url' => 'report.datadiff.php',
				'label' => _('Data diff'),
				'sub_pages' => array('popup_period.php', 'popup_bitem.php', 'chart_bar.php')
			),
			array(
