    ...
    class CHost extends CHostGeneral {
        ...
        public function get($options = array()) {
            ...
            if ($options['searchInventory'] !== null) {
                ...
                zbx_db_search('host_inventory hii', array(
            ...
            //_ex($options,0);
            //_ex($this->createSelectQueryFromParts($sqlParts));
            ...
            if ($options['selectInterfaces'] !== null) {
                if ($options['selectInterfaces'] != API_OUTPUT_COUNT) {
                    $interfaces = API::HostInterface()->get(array(
                        'output'        => $this->outputExtend($options['selectInterfaces'], array(
                                'hostid',
                                'interfaceid'
                            )),
                        'hostids'       => $hostids,
                    ...
                    $interfaces = $this->unsetExtraFields($interfaces, array(
                            'hostid',
                            'interfaceid'
